...
namespace VoicevoxClient.Generated.Model
{
    ...
    public class InstalledLibraryInfo : IEquatable<InstalledLibraryInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstalledLibraryInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstalledLibraryInfo()
        {
        }
        ...
        public InstalledLibraryInfo(string name = default,
            string uuid = default,
            string varVersion = default,
            string downloadUrl = default,
            int bytes = default,
            List<LibrarySpeaker> speakers = default,
            bool uninstallable = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException(
                    "name is a required property for InstalledLibraryInfo and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException(
                    "uuid is a required property for InstalledLibraryInfo and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException(
                    "varVersion is a required property for InstalledLibraryInfo and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException(
                    "downloadUrl is a required property for InstalledLibraryInfo and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException(
                    "speakers is a required property for InstalledLibraryInfo and cannot be null");
            }
